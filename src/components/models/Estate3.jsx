...
const Estate3 = ({ image, payload }) => {
  ...
  return (
    ...
    >
      ...
      <div className="price">
        <div>
          <p style={{ color: "#519E38" }}> {payload.j_price}</p>
        </div>
        <div>
          <p>
            <FaMapMarkerAlt /> {`${payload.j_state},${payload.j_city}`}
          </p>
        </div>
      </div>
      <div className="house-features">
        <p>
          <FaBed color="green" /> {j_bedrooms} Bedroom
        </p>

        <p>
          <FaBath color="green" /> {j_bathrooms} Bathroom
        </p>
        <p>3000 sqft </p>
      </div>
    </Container>
